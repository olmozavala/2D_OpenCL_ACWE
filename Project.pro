...
INCLUDEPATH += "2D_OpenCL_SDF/src/headers"
...
HEADERS += 2D_OpenCL_SDF/src/headers/SignedDistFunc.h

SOURCES += src/*.cpp
SOURCES += src/forms/src/*.cpp
SOURCES += 2D_OpenCL_SDF/src/SignedDistFunc.cpp
